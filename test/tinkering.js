...
const printGraph = (g) => {
  ...
  //   console.log('Node:', g.nodes[i].toString(), '; Value:', g.nodes[i].getValue());
  // }
...
contract('Tinkering 1', (accounts) => {
  ...
  it('Test 1', async () => {
    ...
    // let sup = await g.getArgumentSupport(resAlpha1);
    // console.log(sup);
  });
});
...
contract('Tinkering 2', (accounts) => {
  ...
  it('Test 2', async () => {
    ...
    // const val = await sc.getArgumentSupport(g.nodes[1]);
    // console.log('test: ', val);
    // console.log(g.nodes[1].toString());
    // console.log(resAlpha1);
  });
});
